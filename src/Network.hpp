...
{
	public:
		Network(unsigned int exci=10000, unsigned int inhi=2500);			//!<Constuctor (possibility of changes nb of neurons -> used in the tests)
	...
	private:
		...
		const double J_=0.1;												//!<spike response amplitude
